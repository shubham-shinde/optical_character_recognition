...
model_name = 'symbols-v3'

run = wandb.init(project="symbols", entity="kaizen")
wandb.config = {
    "learning_rate": lr,
    "lr_gamma": lr_gamma,
    "epochs": epochs,
...
class Net(nn.Module):
    def __init__(self):
        ...
        c1 = 4
        self.conv1 = nn.Conv2d(1, c1, 3) # 30 * 30 * 4
        self.bn1 = nn.BatchNorm2d(c1)
#         self.pool = nn.MaxPool2d(2, 2)
        c2 = 6
        self.conv2 = nn.Conv2d(c1, c2, 3) # 28 * 28 * 5
        self.bn2 = nn.BatchNorm2d(c2)
        c3 = 8
        self.conv3 = nn.Conv2d(c2, c3, 3) # 26 * 26 * 6
        self.bn3 = nn.BatchNorm2d(c3)
        c4 = 12
        self.conv4 = nn.Conv2d(c3, c4, 3) # 24 * 24 * 8
        self.bn4 = nn.BatchNorm2d(c4)
        c5 = 18
        self.conv5 = nn.Conv2d(c4, c5, 3) # 22 * 22 * 12
        self.bn5 = nn.BatchNorm2d(c5)
        c6 = 24
        self.conv6 = nn.Conv2d(c5, c6, 3) # 20 * 20 * 16
        self.bn6 = nn.BatchNorm2d(c6)
        c7 = 30
        self.conv7 = nn.Conv2d(c6, c7, 3) # 18 * 18 * 20
        self.bn7 = nn.BatchNorm2d(c7)
        self.fc_1 = nn.Linear(c7 * 18 * 18, 2048)
